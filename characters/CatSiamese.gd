...
func _draw():
	# 身体 - 修长 42x34
	draw_ellipse(Rect2(Vector2(0, 8) - Vector2(21, 17), Vector2(42.0, 34.0)), body_color)
	draw_arc(Vector2(0, 8), 42, 0, TAU, 32, outline_color, 1.5)

	# 胸腹浅色区
	draw_ellipse(Rect2(Vector2(0, 14) - Vector2(11, 10), Vector2(22.0, 20.0)), light_color)
	...
	draw_ellipse(Rect2(Vector2(0, -28) - Vector2(7, 5), Vector2(14.0, 10.0)), outline_color)
	...
	# 眼睛 - 杏仁形 高=宽x0.6
	draw_ellipse(Rect2(Vector2(-9, -30) - Vector2(2.5, 2), Vector2(5.0, 4.0)), outline_color)
	draw_ellipse(Rect2(Vector2(9, -30) - Vector2(2.5, 2), Vector2(5.0, 4.0)), outline_color)
	# 瞳孔 - 细长暗椭圆
	draw_ellipse(Rect2(Vector2(-9, -30) - Vector2(1, 1.5), Vector2(2.0, 3.0)), Color.BLACK)
	draw_ellipse(Rect2(Vector2(9, -30) - Vector2(1, 1.5), Vector2(2.0, 3.0)), Color.BLACK)
	...
	# 前爪 - CAT_SIAM_POINT
	draw_ellipse(Rect2(Vector2(-20, 22) - Vector2(4, 3), Vector2(8.0, 6.0)), outline_color)
	draw_ellipse(Rect2(Vector2(20, 22) - Vector2(4, 3), Vector2(8.0, 6.0)), outline_color)
