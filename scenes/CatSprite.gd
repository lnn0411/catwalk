...
const PER_ANIM_SCALE := {
	...
	"siamese": {
		"walk_right": 0.2394,
		"walk_up_right": 0.2630,
		"walk_up": 0.2585,
		"walk_down_right": 0.2603,
		"walk_down": 0.2277,
		"idle": 0.2296,
		"idle_side_right": 0.2390,
...
const SIAMESE_FRAME_METRICS := {
	...
	"back_right": [{"f": 389, "x": 24.59}, {"f": 389, "x": 32.69}, {"f": 389, "x": 30.59}, {"f": 389, "x": 27.0}, {"f": 399, "x": 21.81}, {"f": 389, "x": 8.36}, {"f": 389, "x": 14.93}, {"f": 389, "x": 16.09}],
