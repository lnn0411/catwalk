...
const PER_ANIM_SCALE := {
	...
	"british": {
		"walk_right": 0.3149,
		"walk_up_right": 0.3235,
		"walk_up": 0.2524,
		"walk_down_right": 0.2500,
		"walk_down": 0.2790,
		"idle": 0.3167,
		"idle_front": 0.3167,
		"idle_side_right": 0.3162,
		"idle_front_right": 0.3280,
		"idle_back_right": 0.2478,
		"idle_back": 0.2399,
		"turn": 0.2952,
		"move_turn": 0.2952,
	},
...
func _draw() -> void:
	if not shadow_enabled:
		return
	_draw_oval(Vector2(0, 3), Vector2(50, 12), Color(0.12, 0.14, 0.06, 0.10))
