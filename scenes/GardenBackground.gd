...
func _draw():
	...
	for pos in grass_positions:
		draw_ellipse(Rect2(pos - Vector2(4, 2), Vector2(8.0, 4.0)), grass_color)
		draw_ellipse(Rect2(pos + Vector2(6, -3) - Vector2(3, 1.5), Vector2(6.0, 3.0)), grass_color)
		draw_ellipse(Rect2(pos + Vector2(-5, -2) - Vector2(2.5, 1.5), Vector2(5.0, 3.0)), grass_color)
