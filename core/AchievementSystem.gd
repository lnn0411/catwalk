...
const ACHIEVEMENTS: Array[Dictionary] = [
	...
	{id = "B3", name = "猫咪旅馆", category = "collection", type = "album_entries", target = 12, reward = {diamonds = 50, treasure_box = 1}},
	{id = "B4", name = "动物园园长", category = "collection", type = "album_entries", target = 24, reward = {diamonds = 100, title = "猫图鉴大师"}},
